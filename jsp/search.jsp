  ...
  <div class="container right-panel-active">
      ...
      <div class="container__form container--signup">
        <form action="#" class="form" id="form1">
          ...
          <button  class="location_text sign_btn" type="button" onclick="signBtnEvent()">Go to Login?</button>
          <button id="search_id_finish_btn" class="btn finish_btn" type="button" onclick="searchIdFinishBtnEvent()">Search Id</button>
      ...
      <div class="container__form container--signin">
        <form action="#" class="form" id="form2">
          ...
          <button class="location_text sign_btn" type="button" onclick="signBtnEvent()">Go to Login?</button>
          <button id="search_pw_finish_btn" class="btn finish_btn" type="button" onclick="searchPwFinishBtnEvent()">Search Pw</button>

...
%>
                    <button class="total_schedule_btn" onclick="dateBtnEvent(<%=i%>,<%=dateIdxList.get(listCount)%>)"><%=totalScheduleList.get(listCount)%>개</button>
<%          
                listCount++;
            } 
...
%>
                    <button class="total_schedule_btn" onclick="dateBtnEvent(<%=i%>,<%=dateIdxList.get(listCount)%>)"></button>
<%
                listCount++;
            } 
            else {
%>
                    <button class="total_schedule_btn" onclick="dateBtnEvent(<%=i%>,-1)"></button>
<%
            }
        } 
        else {
...
%>
    ...
    <script>
        ...
        function dateBtnEvent(day,dateIdx) {

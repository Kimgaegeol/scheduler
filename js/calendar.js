...
const prevMonthBtn = document.getElementById("prev_month_btn");
...
function setCalendar () {
  ...
  var monthNames = ["January", "February", "March", "April", "May", "June","July", "August", "September", "October", "November", "December"]; // 달 이름을 영어로 출력하기 위한 배열

  todayMonthBtn.innerHTML = `${viewYear} ${monthNames[viewMonth]}`;
